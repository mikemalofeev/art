...
<div class="row">
    ...
    <div class="medium-6 columns">
        <div class="main-product-image">
            <img id="main-product-image" class="thumbnail" src="/image/popart/1.jpg" >
        </div>
        ...
        <div class="row small-up-4">
            <div class="column product-thumbs" style="margin-left: 75px;">
                <img class="thumbnail sim-thumb mini-product-img" src="/image/popart/1.jpg" data-image="/image/popart/1.jpg">
            </div>
            <div class="column product-thumbs">
                <img class="thumbnail sim-thumb mini-product-img" src="/image/popart/2.jpg" data-image="/image/popart/2.jpg">
            </div>
            <div class="column product-thumbs">
                <img class="thumbnail sim-thumb mini-product-img" src="/image/popart/3.jpg" data-image="/image/popart/3.jpg">
            </div>
            {{--<div class="column product-thumbs">--}}
    ...
    <div class="medium-6 large-5 columns">
        <h3>Фото-картина ПОП АРТ на холсте</h3>
        ...
        <input type="hidden" id="description" name="description" value="Фото-картина ПОП АРТ на холсте">
        <input type="hidden" id="price" name="price" value="2850">
