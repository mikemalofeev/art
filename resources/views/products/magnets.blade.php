    ...
    <div class="medium-6 large-5 columns">
        ...
        <label>Выберите количество:
            <select id="size" name="size">
                <option value="1 шт." data-price="100">1 шт.</option>
                <option value="2 шт." data-price="200">2 шт.</option>
                <option value="3 шт." data-price="300">3 шт.</option>
                <option value="4 шт." data-price="400">4 шт.</option>
                <option value="5 шт." data-price="500">5 шт.</option>
                <option value="6 шт." data-price="600">6 шт.</option>
                <option value="7 шт." data-price="700">7 шт.</option>
                <option value="8 шт." data-price="800">8 шт.</option>
                <option value="9 шт." data-price="900">9 шт.</option>
                <option value="10 шт." data-price="1000">10 шт.</option>
            </select>
        </label>
...
<div class="column row">
    ...
    <div class="tabs-content" data-tabs-content="example-tabs">
        <div class="tabs-panel is-active" id="panel1">
            {{--<h4>Описание</h4>--}}
            <p>
                Акриловые магнитики с Вашими фотографиями.
            </p>
            <p>
                Выбирайте: квадратные или прямоугольные.
            </p>
        </div>
    </div>
