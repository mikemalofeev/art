    ...
    <div class="medium-6 large-5 columns">
        ...
        <label>Выберите размер:
            <select id="size" name="size">
                @foreach (Lang::get('prices.calendar') as $size => $price)
    ...
    <div class="tabs-content" data-tabs-content="example-tabs">
        <div class="tabs-panel is-active" id="panel1">
            ...
            <p>
                ...
                В стоимость входит подготовка макета к печати.<br />
                Размещение Ваших снимков на страницах календаря.<br />
                Полноцветная печать календаря + сшивка на пружину + крепление на стену.<br />
            </p>
        </div>
    </div>
