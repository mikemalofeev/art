@php
    $name = 'Композиция из 6 фото-картин на холсте';
    $folder = '/image/composition/8';
@endphp
    ...
    <div class="medium-6 large-5 columns">
        ...
        <label>Размер
            <select id="size" name="size">
                <option value="20х30 см - 4 шт, 30х45 см - 1 шт, 50х70 см - 1 шт" data-price="{{ trans('prices.compositions.8') }}">20х30 см - 4 шт, 30х45 см - 1 шт, 50х70 см - 1 шт</option>
            </select>
        </label>
    ...
    <div class="tabs-content" data-tabs-content="example-tabs">
        <div class="tabs-panel is-active" id="panel1">
            ...
            <p>
                ...
                50х70 см - 1 шт<br />
                <br />
                *При оформлении заказа больше 4000 руб - мы дарим Вам накопительную бонусную карту -5%. Скидка начисляется сразу.<br />
            </p>
        </div>
    </div>
