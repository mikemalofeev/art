@php
    $name = 'Триптих на холсте "Love Story"';
    $folder = '/image/composition/6';
@endphp
    ...
    <div class="medium-6 large-5 columns">
        ...
        <label>Размер
            <select id="size" name="size">
                <option value="30х45 см - 1 шт, 20х30 см - 2 шт" data-price="{{ trans('prices.compositions.6') }}">30х45 см - 1 шт, 20х30 см - 2 шт</option>
            </select>
        </label>
...
<div class="column row">
    ...
    <div class="tabs-content" data-tabs-content="example-tabs">
        <div class="tabs-panel is-active" id="panel1">
            ...
            <p>
                Форматы:<br />
                30х45 см - 1 шт и две маленьких 20х30 см<br />
            </p>
        </div>
    </div>
