@php
    $name = 'Панно из 4х фото-картин на холсте';
    $folder = '/image/composition/5';
@endphp
    ...
    <div class="medium-6 large-5 columns">
        ...
        <label>Размер
            <select id="size" name="size">
                <option value="50х70 см - 1 шт, 20х30 см - 3 шт" data-price="{{ trans('prices.compositions.5') }}">50х70 см - 1 шт, 20х30 см - 3 шт</option>
            </select>
        </label>
...
<div class="column row">
    ...
    <div class="tabs-content" data-tabs-content="example-tabs">
        <div class="tabs-panel is-active" id="panel1">
            {{--<h4>Описание</h4>--}}
            <p>
                Главное фото 50х70 см, три маленьких имеют размер 20х30 см<br />
