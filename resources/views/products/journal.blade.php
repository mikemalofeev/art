...
{{--            </div>--}}
{{--            <div class="column product-thumbs">--}}
{{--                <img class="thumbnail sim-thumb mini-product-img" src="{{$folder}}/5.jpg" data-image="{{$folder}}/5.jpg">--}}
{{--            </div>--}}
            {{--<div class="column">--}}
    ...
    <div class="medium-6 large-5 columns">
        ...
        <label>Размер:
            <select id="size" name="size">
                @foreach (Lang::get('prices.journal') as $size => $price)
...
<div class="column row">
    ...
    <div class="tabs-content" data-tabs-content="example-tabs">
        <div class="tabs-panel is-active" id="panel1">
            {{--<h4>Описание</h4>--}}
            <p>
                Замечательный фото-журнал с мягкой обложкой - вариант фотокниги, который в последнее время получил большую популярность!
                <br /><br />

                ✅Отличное качество <br />
                ✅Мелованная плотная бумага, как в глянцевых журналах <br />
                ✅Размер: 20х20, 44 стр. <br />
                От Вас только фото. <br />
                Срок изготовления 1-2 дня.<br />
            </p>
        </div>
    </div>
