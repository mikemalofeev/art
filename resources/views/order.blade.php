    ...
    @else
        ...
        <div style="height: 350px;font-size: 18px;">
            <ul class="" style="list-style-type: none;">
                <li>✓ Спасибо, что сделали у нас заказ!</li>
                <li>✓ После обработки заказа с Вами свяжется наш менеджер.</li>
                <li>✓ Для начала выполнения заказа необходимо произвести оплату. <a href="https://money.yandex.ru/to/410012566285571">Оплатить &raquo;</a></li>
            </ul>
